...
public interface IViewEngine
{
    ...
    ///     <c>Mods/MyMod/Views/MyView</c>.
    /// </param>
    /// <returns>
    ///     An <see cref="IViewDrawable" /> for drawing directly to the <see cref="SpriteBatch" /> of a rendering
    ...
    /// </param>
    /// <returns>
    ///     A controller object whose <see cref="IMenuController.Menu" /> is the created menu and whose other
    ...
    ///     <see cref="Game1.activeClickableMenu" />.
    /// </returns>
    ...
    ///     The prefix for all asset names, e.g. <c>Mods/MyMod/Sprites</c>. This can be any value
    ///     but the same prefix must be used in <c>@AssetName</c> view bindings.
    /// </param>
    /// <param name="modDirectory">
    ///     The physical directory where the asset files are located, relative to the mod
    ///     directory. Typically a path such as <c>assets/sprites</c>.
    /// </param>
    ...
    /// </summary>
    /// <param name="assetPrefix">
    ///     The prefix for all asset names, e.g. <c>Mods/MyMod/Views</c>. This can be any value
    ///     but the same prefix must be used in <c>include</c> elements and in API calls to create views.
    /// </param>
    /// <param name="modDirectory">
    ///     The physical directory where the asset files are located, relative to the mod
    ///     directory. Typically a path such as <c>assets/views</c>.
    /// </param>
...
public interface IMenuController : IDisposable
{
    ...
    ///     The location within the <paramref name="texture" /> where the image is located, or
    ///     <c>null</c> to draw the entire <paramref name="texture" />.
    /// </param>
    /// <param name="scale">
    ...
    /// <param name="right">
    ///     The gutter width on the right side of the viewport. The default value of <c>-1</c> specifies
    ///     that the <paramref name="left" /> value should be mirrored on the right.
    /// </param>
    /// <param name="bottom">
    ///     The gutter height at the bottom of the viewport. The default value of <c>-1</c> specifies
    ///     that the <paramref name="top" /> value should be mirrored on the bottom.
    /// </param>
...
internal static class ViewEngineExtensions
{
    ...
    ///     Do not pass in this argument, so that <see cref="CallerFilePathAttribute" /> can
